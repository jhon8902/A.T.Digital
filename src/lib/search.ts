...
export const STATIC_SEARCH_ENTRIES: SearchEntry[] = [
  ...
  },
  {
    ...
    description: "Costo total de propiedad de un vehiculo en Colombia.",
    href: "/calculadora-tco",
  ...
  },
  {
    ...
    description: "Programa B2B de leads calificados con AutoMatch.",
    href: "/concesionarios",
    category: "concesionarios",
    type: "pagina",
    keywords: ["b2b", "dealer", "leads", "test drive", "panel"],
  },
  {
    title: "Registro",
